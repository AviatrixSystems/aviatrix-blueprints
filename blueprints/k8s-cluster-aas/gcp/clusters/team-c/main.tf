...
locals {
  ...
  network_name   = data.terraform_remote_state.network.outputs.team_c_network_name
  subnet_name    = data.terraform_remote_state.network.outputs.team_c_gke_nodes_subnet_name
  pods_range     = data.terraform_remote_state.network.outputs.team_c_pod_range_name
  services_range = data.terraform_remote_state.network.outputs.team_c_services_range_name
  master_cidr    = data.terraform_remote_state.network.outputs.team_c_master_cidr
