# -----------------------------------------------------------------------------
# Pattern C: GKE Non-Production Cluster (inline — replaces broken gke-cluster module)
...
# -----------------------------------------------------------------------------
# Non-Production GKE Cluster (control plane only — node pool managed in nodes/nonprod)
# -----------------------------------------------------------------------------
