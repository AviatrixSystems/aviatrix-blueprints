...
output "vpc_id" {
  ...
  value       = module.backend_eks.vpc_id
}
...
output "cluster_primary_security_group_id" {
  ...
  value       = module.backend_eks.cluster_primary_security_group_id
}

output "node_security_group_id" {
  description = "Security group ID for EKS nodes"
  value       = module.backend_eks.node_security_group_id
}

output "pod_security_group_id" {
  description = "Security group ID for EKS pods"
  value       = module.backend_eks.pod_security_group_id
}

# OIDC outputs (for IRSA)
output "cluster_oidc_issuer_url" {
  description = "OIDC issuer URL"
  value       = module.backend_eks.cluster_oidc_issuer_url
}

output "oidc_provider_arn" {
  description = "OIDC provider ARN"
  value       = module.backend_eks.oidc_provider_arn
}

# IAM role outputs
output "alb_controller_role_arn" {
  description = "IAM role ARN for AWS Load Balancer Controller"
  value       = module.backend_eks.alb_controller_role_arn
}
