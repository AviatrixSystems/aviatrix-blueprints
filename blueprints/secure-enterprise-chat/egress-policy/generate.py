...
def render_policy(
    ...
    # Header
    lines.append("# Generated by egress-policy/generate.py")
    lines.append(f"# Source: librechat.yaml (sha: {config_sha}), .env (sha: {env_sha})")
    lines.append(
        f"# Regenerate: python egress-policy/generate.py "
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output", default="egress-policy/firewall-policy.yaml", help="Output path"
    )
